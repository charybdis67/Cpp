...
int main(){
	...
	srs.addCourse(200, 4, "D", 3);
	srs.addCourse(300, 3, "A", 4);
	srs.addCourse(300, 2, "C-", 3);
	srs.addCourse(200, 3, "A-", 4);
	srs.addCourse(100, 1, "B-", 2);
	srs.addCourse(200, 2, "D", 3);
	srs.addCourse(300, 1, "A+", 2);
	srs.addCourse(200, 1, "C+", 2);
	cout << "[Done] Add Courses."<< endl;
	cout << "[Running] Remove Course."<< endl;
	srs.removeCourse(100, 1);
	srs.removeCourse(200, 4);
	srs.removeCourse(300, 3);
	srs.removeCourse(200, 2);
	srs.removeCourse(300, 1);
	srs.removeCourse(200, 3);
	cout << "[Done] Remove Course."<< endl;
	cout << "[Running] Calculate Course GPA."<< endl;
	bool result = true;
	vector<CourseGrade> grades;
	grades.push_back(CourseGrade(1, 2.3));
	grades.push_back(CourseGrade(2, 1.7));
	grades.push_back(CourseGrade(3, 0.0));
