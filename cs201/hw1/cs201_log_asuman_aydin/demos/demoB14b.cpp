...
int main(){
	...
	srs.addCourse(100, 1, "B", 4);
	srs.addCourse(100, 2, "B", 4);
	srs.addCourse(300, 2, "FX", 4);
	srs.addCourse(200, 3, "B", 4);
	srs.addCourse(200, 2, "C", 4);
	srs.addCourse(300, 1, "B", 4);
	srs.addCourse(100, 3, "B", 4);
	srs.addCourse(200, 1, "A", 4);
	srs.addCourse(300, 3, "F", 4);
	...
	studentList1.push_back(StudentT(100, "StudentA", 3.0));
	studentList1.push_back(StudentT(200, "StudentB", 3.0));
	studentList1.push_back(StudentT(300, "StudentC", 1.0));
